...
public class ScoreInfoBO extends IbatisBaseBO {
	...
	public List queryForList(Object obj) throws Exception {
		return dao.queryForList("queryScoreList",obj);
	}
	...
	public void transOperation(Object[] obj) throws Exception {
		...
		dao.delete("deleteScoreInfo",obj[0]);
		for(int i = 0;i < obj.length;i++){
			dao.insert("insertScoreInfo",obj[i]); 
		}
	}
	
	public String calc(ScoreInfoVO vo){
		return ((Double)dao.queryForObject("queryForCalcScore",vo)).toString();
	}
