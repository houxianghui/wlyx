...
public class Monitor {
	...
	public static Pattern awards = Pattern.compile("awards_view \\( (\\d+) \\)\">(全民福利礼包|辎重营荣誉礼包|中秋.*?月饼礼包|.{2}成绩单|.{2}月饼|竞技礼包|.{2}天机石|英雄纪念礼包|减负报告单|完成任务得礼包|竞技场挑战得礼包|茶油灯芯礼包|兔年元宵灯笼|纸糊帖礼包|竹篾骨架礼包|春节红包|春节黄酒礼包|减负报告单出售|国家贡献\\d+级红包|.{0,10}援军令|青铜宝箱兑换|.{1,2}龙年|.{1,11}集字|勇者闯关得金券|幻境塔通关礼包|遗失的包裹|挑战礼包|上线得礼包).*?(立即领取|已领取)",Pattern.DOTALL);
