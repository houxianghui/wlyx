	...
	*/
	...
	public static Date getMonday(Date date){
		...
		if(day == Calendar.SUNDAY){
			...
			c.add(Calendar.DATE, Calendar.MONDAY-day);
		}
		return c.getTime();
	}
	
	public static Date getMonday(String date){
		return getMonday(parseDate(date));
	}
	public static String getMondayStr(String date){
		return format(getMonday(date));
	}
	public static Date getNextMonday(String date){
		String d = getDateAfter(getMondayStr(date), 7);
		return getMonday(d);
	}
	public static String getNextModayStr(String date){
		return format(getNextMonday(date));
	}
	public static Date getPreMonday(String date){
		return getMonday(getDateBefore(getMondayStr(date), 7));
	}
	public static String getPreMondayStr(String date){
		return format(getPreMonday(date));
	}
	...
	public static Date getSunday(String date){
		return getSunday(parseDate(date));
	}
	public static String getSundayStr(String date){
		return format(getSunday(date));
	}
	public static Date getNextSunday(String date){
		String d = getDateAfter(date, 7);
		return getSunday(d);
	}
	public static String getNextSundayStr(String date){
		return format(getNextSunday(date));
	}
	public static Date getPreSunday(String date){
		return getSunday(getDateBefore(date, 7));
	}
	public static String getPreSundayStr(String date){
		return format(getPreSunday(date));
	}
}
