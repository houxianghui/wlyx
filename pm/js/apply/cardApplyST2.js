...
function checkForm(){
	...
	var fielde = new Array("app_lmt","cust_name","last_name","first_name","nationality","birthday","fami_member","cert_no","pre_addr","pre_city_code","pre_post","pre_years","pre_zone_no","pre_phone","per_income","ave_income","comp_name","comp_addr","comp_city_code","comp_post","comp_zone_no","comp_phone","work_years","lm_name","lm_comp","lm_comp_zoneno","lm_comp_phone","lm_pre_addr","lm_pre_zoneno","lm_pre_phone","app_source","exam_node_name"); 
	...
	//执行校验   文本框 
	//修改 学生卡电子邮箱可以为空
	var field = new Array("app_lmt","cust_name","last_name","first_name","nationality","birthday","cert_no","pre_addr","pre_city_code","pre_post","pre_years","reg_post","per_income","ave_income","comp_name","comp_addr","comp_city_code","comp_post","work_years","lm_name","app_source","exam_node_name","reg_addr"); 
	var info = new Array("拟申请额度","客户姓名","客户姓(拼音)","客户名(拼音)","客户国籍","客户出生日期","证件号码","现住址","现住址城市代码","现住址邮编","现住址居住年限","预计毕业时间","个人年收入","家庭人均年收入","学校全称","学校地址","学校地址城市代码","学校邮编","在读年级","联系人姓名","申请表来源","网点编号","学校联系人姓名"); 
	...
	var fieldB = new Array("cust_sex","cert_type","edu_degr","lm_sex","exam_mode","get_card_mode","post_addr","relation_bet","pre_reg_addr","car_type"); 
	var infoB = new Array("客户性别","证件类型","在读学历","联系人性别","调查方式","领卡方式","密码,对帐单邮寄地址","家庭联系人与申请人关系","学校联系人与申请人关系","联系地址是否同现住址"); 
	...
	//普卡申请金额不能低于2000元
	/**20070912 modify by yly 
	/*对大学生卡拟申请额度不控制*/
	if(document.forms[0].card_kind.value==1){
		if(!(document.forms[0].card_single_code.value =="AT" || document.forms[0].card_single_code.value =="14" || document.forms[0].card_single_code.value =="33" || document.forms[0].card_single_code.value =="34" || document.forms[0].card_single_code.value =="35")){
	    	if(parseInt(obj.value,10) < 1000){
				alert("普卡最低授信人民币1000元!");
				obj.focus();
				return false;
		    }	
		}
   ...
   if(getSelectedButton(document.forms[0].cert_type)== 0){
	...
	var info = new Array("现住址邮编","预计毕业时间","学校邮编"); 
	...
	/*检查手机号=======================================*/
	var field = new Array("pre_mobile","lm_mobile","car_no"); 
	var info = new Array("申请人手机号","联系人手机号","联系人手机号"); 
	...
	//校验：如果电话号码不为空，则电话号码不能小于7位
	var field = new Array("pre_phone","comp_phone","lm_pre_phone","lm_comp_phone"); 
	var info = new Array("申请人现住址电话","申请人学校电话","联系人住址电话","家庭联系人单位电话号码"); 
	
	var tmp;
	var temp2;
	for(var i=0;i<field.length;i++){
		tmp = "document.forms[0]."+field[i]+".value.length";
		temp2 = "document.forms[0]."+field[i]+".value";
		if(!isEmpty(eval(temp2))){
			if(eval(tmp) < 7){
	...
	//1.校验如果手机号已经输入了,则申请人联系电话区号及电话号码－－无所谓输入
	//2.如果手机号没有输入，则申请人联系电话区号及号码必须全部输入
	var pre_zoneno_st = document.forms[0].pre_zone_no;//申请人联系电话区号
	var pre_phone_st = document.forms[0].pre_phone;//申请人电话号码
	var pre_mobile_st = document.forms[0].pre_mobile;//申请人手机号码
	
	if(isEmpty(pre_mobile_st.value)){//2
		if(isEmpty(pre_phone_st.value)){
			alert("请输入申请人联系电话");
			pre_phone_st.focus();
			return false;
		}
...
//==============================================	
	var comp_zoneno_st = document.forms[0].comp_zone_no;//申请人学校联系人联系电话区号
	var comp_phone_st = document.forms[0].comp_phone;//申请人学校联系人电话号码
	var comp_mobile_st = document.forms[0].car_no;//申请人学校联系人手机号码
	


//===============================================	
	var lm_pre_zoneno_st = document.forms[0].lm_pre_zoneno;//家庭联系人联系电话区号
	var lm_pre_phone_st = document.forms[0].lm_pre_phone;//家庭联系人电话号码
	var lm_pre_mobile_st = document.forms[0].lm_mobile;//家庭联系人手机号码
...
//=================================================	
	...
	var infov = new Array("姓名(中文)","证件号码","现住址","现住址电话号码","学校全称","学校地址","学校电话号码","预留问题","预留答案","联系人姓名(中文)","联系人现住址电话号码","学校联系人姓名","车牌号","车品牌","联系人单位电话号码","联系人现住址","其他证件名称"); 
	...
	*/
	...
	var graduate_time = document.forms[0].reg_post.value;
    if(!checkGraduateDate(graduate_time)){
    	document.forms[0].reg_post.focus();
    	return false;
    }

	//联系地址是否为现住址：若“同现住址”，则联系地址不填；若另列，则联系地址必填
	var car_type = getSelectedButton(document.forms[0].car_type);
	if(car_type == 1){
		if(isEmpty(document.forms[0].lm_pre_addr.value)){
			alert("请输入联系地址");
			document.forms[0].lm_pre_addr.focus();
			return false;
		}
	}
	//若证件类型不为"其他",则"请注明"文本框为空,不填值
...
//检查预计毕业时间
function checkGraduateDate(str){
	if(str.length==0){alert("预计毕业时间输入不正确");return false;}
	Y=str.substring(0,4);
	M=str.substring(4,6);
	if(Y<1900 || Y>2100){
		alert("预计毕业时间输入不正确");
	...
	if( (M < 1) || (M > 12) || (Y < 0))	{alert("预计毕业时间输入不正确");return false;}
	return true;
}
