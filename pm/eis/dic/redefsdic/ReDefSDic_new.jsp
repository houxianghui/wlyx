...
<input type=hidden name=step value="commit"> 
 ...
 <%=ViewUtil.getTitle("增加自定义单级字典")%> 
 
    <table align="center" width="98%"  class="dtPanel_Line3"   border="0" cellspacing="1" cellpadding="0"> 
              
        <tr bgcolor="#FFFFFF"> 
          <td width="35%" align="right" class="dtPanel_Left">&nbsp;<%=ViewUtil.must()%>规类码：</td> 
         <td align="left" class="dtPanel_Main2">&nbsp; 
         <html:text property="type_id" styleClass="Textfield"  size="4" maxlength="4" /> 
         </td> 
       </tr> 
