...
function init(d_start,d_end)
{
     ...
     temp_str="<table border=\"1\" bgcolor=\"#B9D3EE\" bordercolor=\"white\"><tr><td colspan=7 onmouseover=\"overcolor(this)\">";
     temp_str+="<input type=\"Button\" value=\"<<\" onclick=\"change_date(-1,1)\" onmouseover=\"getlayerfocus()\" style=\"color: #FFFFFF; background-color: #7D9EC0; cursor: hand\">&nbsp;";//左面的箭头
     ...
     temp_str+="</select>&nbsp;";
     temp_str+=""//右箭头
     temp_str+="<input type=\"Button\" value=\">>\" onclick=\"change_date(1,1)\" onmouseover=\"getlayerfocus()\"  style=\"color: #FFFFFF; background-color: #7D9EC0; cursor: hand\">";
...
//obj=eval(form1.g_object)
//str=obj.value;
cur_d=new Date()
//cur_d=new Date(str.substring(0,4),str.substring(4,6)-1,str.substring(6,8));
