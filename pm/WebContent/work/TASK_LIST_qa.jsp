    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
    	<tr class="dtPanel_Top01">
         ...
         <tr class="dtPanel_Top02"> 
            ...
            &nbsp;项目/任务编号：<html:text property="project_no_f" styleClass="Textfield" size="4" maxlength="4" />&nbsp; 
		...
		<table width="98%" class="dtPanel_Line1" border="0" cellspacing="1" align="center" cellpadding="0"> 
			...
			%> 
					<tr align="center" class="dtPanel_Main" onclick="_clickTr( this )"> 
						...
						<%}else{ %>
							<td><a class=fontlink1 href="WorkDaily.do?act=view&date=<%=vo.getTask_date()%>&user=<%=vo.getTask_user() %>"><%=vo.getTask_date()%></a></td> 
						<%} %>
