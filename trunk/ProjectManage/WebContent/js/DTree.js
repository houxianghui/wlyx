...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		...
		str += '<a onfocus="blur()" id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" href="' +this.config.linksAttr+'&root_id='+this.rootid+'&docId='+node.id+'"';
