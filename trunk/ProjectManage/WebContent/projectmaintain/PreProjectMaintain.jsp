...
<jsp:useBean id="projectMaintainForm" scope="request"
	class="com.projectmaintain.ProjectMaintainForm" />
<head>
<title>修改用户列表</title>
...
<html:form method="post" action="ProjectMaintain.do">
	...
	<%=ViewUtil.getTitle("当前项目" + projectMaintainForm.getProjectId())%>

	<table width="98%" align=center class="dtPanel_Left" border="0"
		cellspacing="1" cellpadding="0">
		<tr align="center">
			<td align="center">未投产项目</td>
			<td></td>
			<td>前驱项目</td>
		</tr>
		<tr align="center">
