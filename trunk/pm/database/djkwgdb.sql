...
INSERT INTO `change_record` VALUES (1,'T0001','00000200','20110920','','ts',-1);
...
#
# Source for table daily_achieve
#
...
CREATE TABLE `daily_achieve` (
  ...
  `WORK_ID` varchar(8) DEFAULT NULL,
  `WORK_DATE` char(8) DEFAULT NULL,
  `USER_ID` char(8) DEFAULT NULL,
  `ACHIEVEMENT` varchar(250) DEFAULT NULL,
  `ACHIEVE_PERCENT` char(3) DEFAULT NULL,
  `INPUT_DATE` char(8) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=gbk;

#
# Dumping data for table daily_achieve
#
LOCK TABLES `daily_achieve` WRITE;
/*!40000 ALTER TABLE `daily_achieve` DISABLE KEYS */;

INSERT INTO `daily_achieve` VALUES (1,NULL,NULL,'20110920','00000201','t','100','20110920');
/*!40000 ALTER TABLE `daily_achieve` ENABLE KEYS */;
UNLOCK TABLES;

#
# Source for table daily_issue
#
...
CREATE TABLE `daily_issue` (
  ...
  `ISSUE_PERCENT` char(3) DEFAULT NULL,
  `INPUT_DATE` char(8) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=gbk;

#
# Dumping data for table daily_issue
#
LOCK TABLES `daily_issue` WRITE;
/*!40000 ALTER TABLE `daily_issue` DISABLE KEYS */;

INSERT INTO `daily_issue` VALUES (1,NULL,NULL,'20110920','00000201','t','100','20110920');
/*!40000 ALTER TABLE `daily_issue` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ep_dic_type` VALUES ('1001','任务状态','1');
INSERT INTO `ep_dic_type` VALUES ('1002','日报表头名称','1');
...
INSERT INTO `ep_homepage` VALUES (73,'员工','/ProjectDistribute.do?act=gmp');
...
INSERT INTO `ep_menu` VALUES ('00000325','00000324','当前项目列表','0',2,2,'ProjectMaintain.do?act=qpl');
...
INSERT INTO `ep_menu` VALUES ('00000336','00000324','我的项目列表','0',2,3,'ProjectMaintain.do?act=gmip');
INSERT INTO `ep_menu` VALUES ('00000339','00000324','待审批项目列表','0',2,4,'ProjectDistribute.do?act=gdp');
INSERT INTO `ep_menu` VALUES ('00000340','00000000','任务维护','0',1,1,'');
INSERT INTO `ep_menu` VALUES ('00000341','00000340','当前任务列表','0',2,1,'WorkList.do?act=list');
INSERT INTO `ep_menu` VALUES ('00000342','00000340','所有任务列表','0',2,2,'WorkList.do?act=qa');
INSERT INTO `ep_menu` VALUES ('00000343','00000340','我的任务列表','0',2,3,'WorkList.do?act=gmiw');
INSERT INTO `ep_menu` VALUES ('00000344','00000340','待审批任务列表','0',2,4,'WorkList.do?act=gdw');
INSERT INTO `ep_menu` VALUES ('00000345','00000000','工作分配表','0',1,50,'ProjectDistribute.do?act=display');
INSERT INTO `ep_menu` VALUES ('00000346','00000000','日志检查','0',1,4,'');
INSERT INTO `ep_menu` VALUES ('00000347','00000346','员工工时填写查询','0',2,1,'TASK_LIST.do?act=qa');
INSERT INTO `ep_menu` VALUES ('00000348','00000346','未完成工作查询','0',2,2,'ProjectDistribute.do?act=getNotDoneWorks');
INSERT INTO `ep_menu` VALUES ('00000349','00000346','未填写日报人员检查','0',2,3,'NotWriteNoteStuff.do');
INSERT INTO `ep_menu` VALUES ('00000350','00000000','通讯录','0',1,4,'');
INSERT INTO `ep_menu` VALUES ('00000351','00000350','通讯录','0',2,1,'Lx_info.do?act=list');
INSERT INTO `ep_menu` VALUES ('00000352','00000015','通知维护','0',3,1,'Ep_notice.do?act=list');
INSERT INTO `ep_menu` VALUES ('00000353','00000340','主要问题维护','0',2,5,'MainProblem.do?act=edit');
INSERT INTO `ep_menu` VALUES ('00000354','00000000','签到签退','0',1,99,'SignRecord.do?act=info');
INSERT INTO `ep_menu` VALUES ('00000355','00000000','签到签退维护','0',1,99,'SignRecord.do?act=list');
/*!40000 ALTER TABLE `ep_menu` ENABLE KEYS */;
UNLOCK TABLES;

#
# Source for table ep_notice
#

DROP TABLE IF EXISTS `ep_notice`;
CREATE TABLE `ep_notice` (
  `NOTICE_NO` int(11) NOT NULL AUTO_INCREMENT,
  `NOTICE_COMMENT` varchar(250) DEFAULT NULL,
  `OPER_ID` char(8) DEFAULT NULL,
  `OPER_DATE` char(8) DEFAULT NULL,
  `FILENAME` varchar(50) DEFAULT NULL,
  `NOTICE_TOP` int(11) DEFAULT NULL,
  PRIMARY KEY (`NOTICE_NO`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

#
# Dumping data for table ep_notice
#
LOCK TABLES `ep_notice` WRITE;
/*!40000 ALTER TABLE `ep_notice` DISABLE KEYS */;

/*!40000 ALTER TABLE `ep_notice` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ep_op_def` VALUES ('lx_info_c','00000351','增加通讯录信息');
INSERT INTO `ep_op_def` VALUES ('lx_info_u','00000351','修改通讯录信息');
INSERT INTO `ep_op_def` VALUES ('lx_info_d','00000351','删除通讯录信息');
INSERT INTO `ep_op_def` VALUES ('ep_notice_c','00000352','通知维护');
INSERT INTO `ep_op_def` VALUES ('signmanage','00000355','签到签退维护');
INSERT INTO `ep_op_def` VALUES ('signoff','00000354','签退');
...
INSERT INTO `ep_pmkey` VALUES ('ep_sdic','SYS_ID',100,24800);
INSERT INTO `ep_pmkey` VALUES ('ep_homepage','TEMPL_ID',6,78);
INSERT INTO `ep_pmkey` VALUES ('ep_mdic','SYS_ID',50,760);
INSERT INTO `ep_pmkey` VALUES ('TASK_LIST','TASK_NO',50,41725);
INSERT INTO `ep_pmkey` VALUES ('lx_info','lx_id',10,100);
...
INSERT INTO `ep_role` VALUES ('00000099','员工','stuff',73,60000,'1','00000200','20110824');
...
INSERT INTO `ep_role_auth` VALUES ('00000001','lx_info_c');
INSERT INTO `ep_role_auth` VALUES ('00000001','lx_info_u');
INSERT INTO `ep_role_auth` VALUES ('00000001','lx_info_d');
INSERT INTO `ep_role_auth` VALUES ('00000001','signmanage');
INSERT INTO `ep_role_auth` VALUES ('00000099','tASK_LIST_c');
INSERT INTO `ep_role_auth` VALUES ('00000099','signoff');
...
INSERT INTO `ep_role_menu` VALUES ('00000099','00000354');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000324');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000346');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000340');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000013');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000350');
...
INSERT INTO `ep_role_menu` VALUES ('00000001','00000352');
...
INSERT INTO `ep_role_menu` VALUES ('00000001','00000336');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000339');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000341');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000342');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000343');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000344');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000353');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000345');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000347');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000348');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000349');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000351');
INSERT INTO `ep_role_menu` VALUES ('00000001','00000355');
...
INSERT INTO `ep_sdic` VALUES (24501,'1001','N','正常',1,'N','1');
INSERT INTO `ep_sdic` VALUES (24502,'1001','D','删除',2,'D','1');
INSERT INTO `ep_sdic` VALUES (24503,'1001','F','完成',2,'F','1');
INSERT INTO `ep_sdic` VALUES (24601,'1002','A','V+迁移项目工作日报',1,'A','1');
INSERT INTO `ep_sdic` VALUES (24602,'1002','B','账户管理系统研发项目工作日报',2,'B','1');
INSERT INTO `ep_sdic` VALUES (24701,'0001','4','不导出',4,'4','1');
...
INSERT INTO `ep_user` VALUES ('00000201','01','00000099','test','test','e99a18c428cb38d5f260853678922e03','','','','','','4','20110113','20110113','20130113','20120209','','20110913','00000200');
INSERT INTO `ep_user` VALUES ('00000202','01','00000099','yangquanyu','杨全玉','dd4b21e9ef71e1291183a46b913ae6f2','','','','','','1','20110825','20110825','20130825','20110825','','20110825','00000200');
INSERT INTO `ep_user` VALUES ('00000203','01','00000099','xujinxiu','徐金秀','dd4b21e9ef71e1291183a46b913ae6f2','','','','','','1','20110825','20110825','20130825','20110825','','20110825','00000200');
INSERT INTO `ep_user` VALUES ('00000204','01','00000099','nanguokun','南国坤','dd4b21e9ef71e1291183a46b913ae6f2','','','','','','1','20110825','20110825','20130825','20110825','','20110825','00000200');
INSERT INTO `ep_user` VALUES ('00000205','01','00000099','wangmiao','王淼','dd4b21e9ef71e1291183a46b913ae6f2','','','','','','1','20110825','20110825','20130825','20110825','','20110825','00000200');
INSERT INTO `ep_user` VALUES ('00000206','01','00000099','chaogai','南国坤','dd4b21e9ef71e1291183a46b913ae6f2','','','','','','4','20110826','20110826','20130826','20110826','','20110902','00000200');
...
INSERT INTO `ep_user_role` VALUES ('00000202','00000099');
INSERT INTO `ep_user_role` VALUES ('00000203','00000099');
INSERT INTO `ep_user_role` VALUES ('00000204','00000099');
INSERT INTO `ep_user_role` VALUES ('00000205','00000099');
INSERT INTO `ep_user_role` VALUES ('00000206','00000099');
...
#
# Dumping data for table main_problem
#
LOCK TABLES `main_problem` WRITE;
/*!40000 ALTER TABLE `main_problem` DISABLE KEYS */;

INSERT INTO `main_problem` VALUES (19,'wenti4');
INSERT INTO `main_problem` VALUES (20,'wenti3');
INSERT INTO `main_problem` VALUES (21,'wenti2');
INSERT INTO `main_problem` VALUES (22,'wenti1');
INSERT INTO `main_problem` VALUES (23,'初始化数据库配置');
INSERT INTO `main_problem` VALUES (24,'所发生的');
/*!40000 ALTER TABLE `main_problem` ENABLE KEYS */;
UNLOCK TABLES;
...
#
# Source for table sign_record
#

DROP TABLE IF EXISTS `sign_record`;
CREATE TABLE `sign_record` (
  `USER_ID` char(8) NOT NULL DEFAULT '',
  `RECORD_DATE` char(8) NOT NULL DEFAULT '',
  `RECORD_TIME` char(6) DEFAULT NULL,
  `RECORD_TYPE` char(1) NOT NULL DEFAULT '',
  `IS_MODIFIED` char(1) DEFAULT NULL,
  `MODIFY_USER` char(8) DEFAULT NULL,
  PRIMARY KEY (`USER_ID`,`RECORD_TYPE`,`RECORD_DATE`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
...
INSERT INTO `sign_record` VALUES ('00000200','20111101','105511','I',NULL,NULL);
INSERT INTO `sign_record` VALUES ('00000201','20111101','105740','I',NULL,NULL);
INSERT INTO `sign_record` VALUES ('00000201','20111101','142706','O',NULL,NULL);
INSERT INTO `sign_record` VALUES ('00000201','20111110','180000','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000202','20111102','123456','I','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000202','20111102','180000','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000202','20111116','180000','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000203','20111115','123456','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000204','20111101','180000','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000205','20111101','083001','I','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000205','20111102','083001','I','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000205','20111103','083001','I','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000205','20111101','180000','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000205','20111103','180000','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000205','20111122','123456','O','Y','00000200');
INSERT INTO `sign_record` VALUES ('00000206','20111102','123456','O','Y','00000200');
...
#
LOCK TABLES `work_daily` WRITE;
/*!40000 ALTER TABLE `work_daily` DISABLE KEYS */;

INSERT INTO `work_daily` VALUES (1,NULL,NULL,'20110920','00000201','te','20110920');
/*!40000 ALTER TABLE `work_daily` ENABLE KEYS */;
UNLOCK TABLES;

#
# Source for table work_distribute
#
...
CREATE TABLE `work_distribute` (
  ...
  `INPUT_USER` char(8) DEFAULT NULL,
  `INPUT_DATE` char(8) DEFAULT NULL,
  `NOTIFY_DAY` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=gbk;

#
# Dumping data for table work_distribute
#
LOCK TABLES `work_distribute` WRITE;
/*!40000 ALTER TABLE `work_distribute` DISABLE KEYS */;

INSERT INTO `work_distribute` VALUES (1,'T0003','00000201','20110825','20110915','','N','00000200','20110825',2);
INSERT INTO `work_distribute` VALUES (2,'T0003','00000204','20110825','20110915','','N','00000200','20110825',2);
INSERT INTO `work_distribute` VALUES (3,'T0003','00000205','20110825','20110915','','N','00000200','20110825',2);
INSERT INTO `work_distribute` VALUES (4,'T0003','00000203','20110825','20110915','','N','00000200','20110825',2);
INSERT INTO `work_distribute` VALUES (5,'T0003','00000202','20110825','20110915','','N','00000200','20110825',2);
INSERT INTO `work_distribute` VALUES (6,'T0002','00000204','20110825','20110831','','N','00000200','20110825',3);
INSERT INTO `work_distribute` VALUES (7,'T0002','00000203','20110825','20110831','','N','00000200','20110825',3);
INSERT INTO `work_distribute` VALUES (8,'T0002','00000202','20110825','20110831','','N','00000200','20110825',3);
INSERT INTO `work_distribute` VALUES (9,'T0001','00000205','20110825','20110827','','N','00000200','20110825',1);
INSERT INTO `work_distribute` VALUES (10,'T0001','00000203','20110825','20110827','','N','00000200','20110825',1);
INSERT INTO `work_distribute` VALUES (11,'T0005','00000204','20110810','20110827','','N','00000200','20110825',3);
INSERT INTO `work_distribute` VALUES (12,'T0005','00000205','20110810','20110827','','N','00000200','20110825',3);
INSERT INTO `work_distribute` VALUES (13,'T0005','00000203','20110810','20110827','','N','00000200','20110825',3);
/*!40000 ALTER TABLE `work_distribute` ENABLE KEYS */;
UNLOCK TABLES;

#
# Source for table work_list
#
...
#
LOCK TABLES `work_list` WRITE;
/*!40000 ALTER TABLE `work_list` DISABLE KEYS */;

INSERT INTO `work_list` VALUES ('T0001','RATIONAL全量数据备份及写磁带','JVMX/JILS/JFOOTPRINT投产相关开发测试及讨论，专题会议\r\n日常PRM监控信息整理\r\nRATIONAL全量数据备份及写磁带','N','20110824','20110907','00000200','20110825','N');
INSERT INTO `work_list` VALUES ('T0002','应用系统运维管理规范及SLA','应用系统运维管理规范及SLA\r\n(1)\tJVMX/JILS/JFOOTPRINT\r\n(2)\tCONNEX(3)\tV+','N','20110825','20110922','00000200','20110825','Y');
INSERT INTO `work_list` VALUES ('T0003','联合集成测试','','N','20110825','20110831','00000200','20110825',NULL);
INSERT INTO `work_list` VALUES ('T0004','国际组织清算认证讨论分析','','N','20110825','20111020','00000200','20110825',NULL);
INSERT INTO `work_list` VALUES ('T0005','第3、4次FDC变更代码同步','第3、4次FDC变更代码同步（含国际组织升级代码量较大、FIX方式代码需要全部合并MOD、编译比对等内容','N','20110825','20110922','00000200','20110825','N');
INSERT INTO `work_list` VALUES ('T0008','RATIONAL全量数据备份及写磁带','sadfsd','N','20110921','20110930','00000200','20110920',NULL);
