...
public class ProjectMaintainAction extends IbatisBaseAction {
	...
	public ActionForward process(ActionMapping mapping, BaseForm form, HttpServletRequest request, HttpServletResponse response, UserContext user) throws Exception {
		...
		if("gc".equals(act)){
			return getChangeList(mapping,request);
		}
		if("gmip".equals(act)){
	...
	private ActionForward getChangeList(ActionMapping mapping,HttpServletRequest request)throws Exception{
		String projectId = request.getParameter("projectId");
		setPageResult(request,((ProjectMaintainBO)bo).getChangeRecord(projectId));
